...
export const UPDATE_PRODUCT_DATA = `
  mutation(
    ...
    $minInterestRateMen: String,
    $minInterestRateWomen: String,
    $minProcessingFee: String,
    $minPreclosureCharge: String,
    $maxPreclosureCharge: String,
    $fbProcessingFee: String,
    $minProcessingFeeSlab: String,
    $maxProcessingFeeSlab: String,
    $coApplicantMaxEMI: String,
    $coApplicantMinAge: String,
    $coApplicantMinSalary: String
		) {
