    ...
    <br />
      ...
      <Form>
        <Form.Group controlId="formBasicEmail">
          ...
          <Form.Control type="text" placeholder="Enter Loan Amount" value={loanAmount} onChange={e => setLoanAmount(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Loan City</Form.Label>
          <Form.Control type="text" placeholder="Enter Loan City" value={loanCity} onChange={e => setLoanCity(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Loan Tenure</Form.Label>
          <Form.Control type="text" placeholder="Enter Loan Tenure" value={loanTenure} onChange={e => setLoanTenure(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Loan Purpose</Form.Label>
          <Form.Control type="text" placeholder="Enter Loan Purpose" value={loanPurpose} onChange={e => setLoanPurpose(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Asset Worth</Form.Label>
          <Form.Control type="text" placeholder="Enter Asset Worth" value={assetWorth} onChange={e => setAssetWorth(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Asset City</Form.Label>
          <Form.Control type="text" placeholder="Enter Asset City" value={assetCity} onChange={e => setAssetCity(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Asset State</Form.Label>
          <Form.Control type="text" placeholder="Enter Asset State" value={assetState} onChange={e => setAssetState(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Asset Type</Form.Label>
          <Form.Control type="text" placeholder="Enter Asset Type" value={assetType} onChange={e => setAssetType(e.target.value)} disabled={disabled} />
        </Form.Group>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Home Loan City</Form.Label>
          <Form.Control type="text" placeholder="Enter Home Loan City" value={homeLoanCity} onChange={e => setHomeLoanCity(e.target.value)} disabled={disabled} />
        </Form.Group>
      </Form>
    </>
  );
